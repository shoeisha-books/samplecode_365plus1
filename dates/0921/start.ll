...
$"??_C@_0N@BEEODGFF@Hello?5World?6?$AA@" = comdat any

@"??_C@_0N@BEEODGFF@Hello?5World?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [13 x i8] c"Hello World\0A\00", comdat, align 1
...
define dso_local i32 @start() #0 {
  %1 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0N@BEEODGFF@Hello?5World?6?$AA@")
  ret i32 0
}
...
!1 = !DIFile(filename: "start.c", directory: "C:\\Users\\020370\\Desktop\\\E3\83\AD\E3\83\BC\E3\82\AB\E3\83\AB")
